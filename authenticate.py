...
class Authenticate:
    ...
    def _check_pw(self) -> bool:
        ...
        return bcrypt.checkpw(
            ...
            self.credentials[self.username]['password'].encode())
    ...
    def _check_credentials(self, inplace: bool = True) -> bool:
        ...
        if self.username in self.credentials:
            try:
                if self._check_pw():
                    if inplace:
                        st.session_state['name'] = self.credentials[
                            self.username]['name']
